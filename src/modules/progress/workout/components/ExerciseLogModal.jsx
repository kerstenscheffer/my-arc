// src/modules/progress/workout/components/ExerciseLogModal.jsx - SIMPLIFIED NO SEARCH
...
export default function ExerciseLogModal({ 
  db,
  client,
  exercise, // DIRECT exercise object from ExerciseCard
  onClose, 
  onLogComplete,
  ...
  return (
    <div style={{
      ...
      zIndex: 10000, // VERHOOGD van 2000 naar 10000
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
