...
// 🏆 GOLD THEME - All metrics use gold
    ...
    <div style={{
      ...
      <div style={{
        ...
        <BarChart3 
          size={isMobile ? 10 : 11} 
          style={{
            filter: 'drop-shadow(0 0 4px rgba(255, 215, 0, 0.4))' // GOLD
          }}
        />
        Selecteer Metric
      </div>
      ...
      <div style={{
        ...
        {metrics.map((metric) => {
          ...
          return (
            ...
            >
              {/* Top accent line for active - GOLD */}
              {isActive && (
                <div style={{
                  position: 'absolute',
                  top: 0,
              ...
              {/* Icon Container - GOLD when active */}
              <div style={{
