      ...
      {!controlled && !isOpen && (
        <button
          ...
          style={{
            ...
            borderTop: `1px solid ${unreadCount > 0 ? 'rgba(201,165,90,0.45)' : 'rgba(201,165,90,0.22)'}`,
            borderBottom: `1px solid ${unreadCount > 0 ? 'rgba(201,165,90,0.45)' : 'rgba(201,165,90,0.22)'}`,
            borderLeft: `1px solid ${unreadCount > 0 ? 'rgba(201,165,90,0.45)' : 'rgba(201,165,90,0.22)'}`,
