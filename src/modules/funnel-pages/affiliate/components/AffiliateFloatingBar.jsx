...
import { Check, ChevronRight, Users, X, Euro, TrendingUp } from 'lucide-react'
import DatabaseService from '../../../../services/DatabaseService'

export default function AffiliateFloatingBar({ onOpenCalendly, isMobile: propIsMobile }) {
  ...
  // Loading state - hide bar until data loaded
  if (!spots) {
    return null
  }

  const spotsLeft = spots.max_spots - spots.current_spots
  ...
  const spotsText = spotsLeft <= 0 
    ...
    : spotsLeft === 1 
      ...
      : `Nog ${spotsLeft} Partner Plekken`

  const features = [
    "€200 Per Klant",
    "20% Korting Voor Je Netwerk",
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Spots Counter - DATABASE CONNECTED */}
          <div
            style={{
              display: 'flex',
              alignItems: 'center',
          ...
          >
            <div style={{
              ...
              <Users size={isMobile ? 12 : 14} color={isUrgent ? '#fff' : '#000'} strokeWidth={3} />
            </div>
            <span style={{
              fontSize: isMobile ? '0.8rem' : '0.95rem',
              color: isUrgent 
              ...
              {spotsLeft > 0 && (
                <span style={{
                  ...
                  <span style={{
                    ...
                    height: '6px',
                    borderRadius: '50%',
                    background: isUrgent ? '#ef4444' : '#FFD700',
        ...
        <button
          ...
          style={{
            ...
            borderRadius: '20px',
            color: isHovered ? '#000' : (isUrgent ? '#ef4444' : '#FFD700'),
            cursor: 'pointer',
            display: 'flex',
            alignItems: 'center',
            gap: '0.75rem',
        ...
        >
          ...
          <span style={{ position: 'relative', zIndex: 1 }}>
            {isMobile ? 'WORD PARTNER' : 'IK WIL €200 PER KLANT'}
          </span>
          <ChevronRight 
            size={isMobile ? 18 : 20} 
            style={{ 
