...
import { ArrowDown, Check, TrendingUp, Users, Euro } from 'lucide-react'

export default function AffiliateHero({ isMobile, onScrollNext, onOpenCalendly }) {
    ...
    <section style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Help mensen fitter worden en verdien
          <span style={{ 
            color: '#FFD700',
            fontWeight: '700',
            filter: 'drop-shadow(0 0 10px rgba(255, 215, 0, 0.3))'
          }}> €200 per klant </span> 
          die jij introduceert
        </p>
        ...
        <div style={{
          ...
          {[
            { icon: Euro, value: '€100', label: 'Na 28 dagen' },
            { icon: TrendingUp, value: '+€100', label: 'Na 2e maand' },
            { icon: Users, value: '20%', label: 'Korting voor jouw netwerk' }
          ].map((stat, index) => (
            <div key={index} style={{
        ...
        <div style={{
          ...
          {[
            'Geen verborgen kosten - 100% transparant',
            'Betaling rechtstreeks naar jouw rekening',
