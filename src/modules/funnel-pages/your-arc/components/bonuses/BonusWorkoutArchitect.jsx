...
export default function BonusWorkoutArchitect({ 
  isMobile = window.innerWidth <= 768, 
  imageUrl = 'https://cdn.shopify.com/s/files/1/0862/1237/8954/files/6_ae0688d1-faa6-4b26-87a1-3cec6452f051.png?v=1757838095',
  isVisible = true 
}) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle at center, rgba(249, 115, 22, 0.12) 0%, rgba(249, 115, 22, 0.05) 30%, transparent 70%)',
        filter: 'blur(30px)',
        pointerEvents: 'none',
        zIndex: -1,
      ...
      <div style={{
        ...
        <div style={{
          ...
          overflow: 'hidden',
          position: 'relative',
          boxShadow: '0 15px 30px rgba(0, 0, 0, 0.5), 0 10px 20px rgba(249, 115, 22, 0.15)',
          ...
          <div style={{
            width: '100%',
            height: '100%',
            background: `linear-gradient(135deg, rgba(249, 115, 22, 0.08) 0%, rgba(0, 0, 0, 0.2) 100%), url('${imageUrl}')`,
          ...
          <div style={{
            ...
            <Dumbbell size={isMobile ? 16 : 24} color="#fff" />
          </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          boxShadow: '0 10px 25px rgba(0, 0, 0, 0.4), 0 5px 15px rgba(249, 115, 22, 0.1)',
          position: 'relative'
        }}>
          {/* Top glow line */}
          <div style={{
          ...
          <div style={{
            ...
            {[
              { label: 'Workouts', amount: '€87' },
              { label: 'Form', amount: '€67' },
              { label: 'Tracker', amount: '€47' }
            ].map((item, index) => (
              <div 
                key={index}
                style={{
