...
// COMPACT 2x2 grid - Uses client.target_* like AIMealDashboard
...
export default function Slide2MacroGoals({ client, isMobile }) {
  // ✅ Use client's target values directly from clients table (SAME AS AIMealDashboard)
  const goals = {
    calories: client?.target_calories || 2200,
    protein: client?.target_protein || 165,
    carbs: client?.target_carbs || 220,
    fat: client?.target_fat || 70
  }

  console.log('✅ [Slide2] Loaded goals:', goals)
