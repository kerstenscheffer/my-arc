// src/modules/lead-pic-generator/templates/body/TimelineBody.jsx
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <svg width="350" height="60" style={{ display: 'inline-block' }}>
              <defs>
        ...
        <div style={{
          ...
          <svg width="100" height="40" style={{ display: 'inline-block' }}>
            <defs>
              <linearGradient id="timelineGradient4" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#10b981" />
                <stop offset="100%" stopColor="#3b82f6" />
              </linearGradient>
            </defs>
