...
export default function TransformationSection({ onScrollNext }) {
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          background: 'linear-gradient(135deg, rgba(0, 0, 0, 0.95) 0%, rgba(255, 215, 0, 0.04) 100%)',
          ...
          <h3 style={{
            ...
            zIndex: 1,
            letterSpacing: '-0.02em',
            filter: 'drop-shadow(0 2px 15px rgba(255, 215, 0, 0.4))'
          }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.border = '2px dashed rgba(255, 215, 0, 0.4)'
                e.currentTarget.style.transform = 'scale(1.02)'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.border = '2px dashed rgba(255, 215, 0, 0.2)'
                e.currentTarget.style.transform = 'scale(1)'
              }}>
                <User size={isMobile ? 40 : 60} color="rgba(212, 175, 55, 0.3)" />
                <Camera size={isMobile ? 20 : 24} color="rgba(212, 175, 55, 0.4)" style={{ marginTop: '0.5rem' }} />
                <span style={{
                  fontSize: isMobile ? '0.75rem' : '0.875rem',
            ...
            <div style={{
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.border = '2px solid rgba(255, 215, 0, 0.4)'
                e.currentTarget.style.transform = 'scale(1)'
              }}>
                {/* Shimmer effect */}
                <div style={{
                ...
                <Award size={isMobile ? 40 : 60} color="rgba(255, 215, 0, 0.5)" />
                <span style={{
