      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* YouTube placeholder met thumbnail */}
            <div style={{
              position: 'absolute',
              top: 0,
              left: 0,
              ...
              backgroundImage: 'url(https://cdn.shopify.com/s/files/1/0862/1237/8954/files/Ontwerp_zonder_titel_49.png?v=1758029590)',
              ...
              {!videoPlaying ? (
                ...
                <iframe
                  ...
                  src="https://www.youtube.com/embed/INIdTRVjX80?autoplay=1&loop=1&playlist=INIdTRVjX80"
                  title="MY ARC Video"
          ...
          {/* Video highlights met gouden accenten */}
          <div style={{
            display: 'grid',
            ...
            {[
              { icon: Clock, text: 'In 5  minuten uitgelegd' },
              { icon: Users, text: 'Maar 10 Plekken Beschikbaar' },
              { icon: Calendar, text: 'Start direct maandag' }
            ].map((item, index) => (
              <div key={index} style={{
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            >
              ...
              <span style={{ position: 'relative', zIndex: 1 }}>Plan Je Gesprek Gratis!</span>
            </button>
            ...
            <p style={{
              ...
              Geen verplichtingen • 100% vrijblijvend • Binnen 24 uur reactie
            </p>
          </div>
        </div>
