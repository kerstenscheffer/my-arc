...
export default function GoldenCTAButton({ 
  onClick, 
  text = "Plan Je Gesprek Gratis!", 
  icon = Calendar,
  isMobile,
  fullWidth = false,
  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: isHovered 
          ? '0 25px 50px rgba(255, 215, 0, 0.5), 0 0 120px rgba(255, 215, 0, 0.4), 0 0 60px rgba(212, 175, 55, 0.3), inset 0 0 30px rgba(255, 255, 255, 0.2)'
          : variant === 'primary'
            ? '0 10px 30px rgba(0, 0, 0, 0.7), 0 0 80px rgba(255, 215, 0, 0.25), 0 0 40px rgba(212, 175, 55, 0.2), inset 0 1px 0 rgba(255, 215, 0, 0.1)'
            : '0 8px 25px rgba(0, 0, 0, 0.6), 0 0 60px rgba(255, 215, 0, 0.2), 0 0 30px rgba(212, 175, 55, 0.15)',
    ...
    >
      ...
      {/* Bewegende glans effect - STERKER */}
      <div style={{
        position: 'absolute',
        top: '-50%',
        left: '-30%',
