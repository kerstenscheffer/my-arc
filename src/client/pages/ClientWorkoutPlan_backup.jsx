...
export default function ClientWorkoutPlan({ client, schema }) {
  ...
  return (
    <div className="myarc-animate-in" style={{padding: isMobile ? '0.5rem' : '0'}}>
      ...
      {/* Week Calendar - NO SHADOW, MORE SPACE */}
      <div className="myarc-card myarc-mb-lg">
      ...
      {/* Day Detail Popup - NO TOP MARGIN */}
      {selectedDay && schema.week_structure[selectedDay] && (
        <div style={{
          ...
          <div className="myarc-card" style={{
            ...
            {/* Exercises List - TIGHTER SPACING */}
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      <div className="myarc-card" style={{
                        ...
                        <div className="myarc-text-gray" style={{fontSize: '0.7rem'}}>
                          {t('workout.rest') || 'Rest'}
                        </div>
                      </div>
                      <div className="myarc-card" style={{
                        ...
                        <div className="myarc-text-gray" style={{fontSize: '0.7rem'}}>RPE</div>
                      </div>
                    </div>
                    ...
                    {exercise.notes && (
                      <div className="myarc-card" style={{
                        ...
                        <p className="myarc-text-white" style={{fontSize: isMobile ? '0.8rem' : '0.9rem'}}>
