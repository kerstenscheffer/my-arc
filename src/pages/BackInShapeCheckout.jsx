// src/pages/BackInShapeCheckout.jsx
// Simpele Stripe-betaalpagina voor het "5 Uur Per Week Back In Shape"-programma.
// Garantie + 5 systeem-onderdelen + €597 betaalknop. Bold, groot, wit, leesbaar.
import { useState } from 'react'

const GOLD = '#FFD700'
const PRICE_ID = 'price_1Tic3tJ3V4uXn1Okisbj9eq1'
...
export default function BackInShapeCheckout() {
      ...
      <div style={{ width: '100%', maxWidth: 540 }}>
        ...
        <div style={{ textAlign: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'center', gap: '0.3rem', marginBottom: '0.85rem' }}>
            <span style={{ fontSize: isMobile ? '3rem' : '3.75rem', fontWeight: 900, color: '#fff', lineHeight: 1, letterSpacing: '-0.03em' }}>€597</span>
            <span style={{ fontSize: '0.95rem', fontWeight: 700, color: 'rgba(255,255,255,0.4)' }}>eenmalig</span>
          </div>
