...
output: {
  ...
  backgroundGradient: 'linear-gradient(135deg, rgba(255, 215, 0, 0.1) 0%, rgba(212, 175, 55, 0.05) 100%)',
...
funnel: {
  ...
  backgroundGradient: 'linear-gradient(135deg, rgba(212, 175, 55, 0.1) 0%, rgba(184, 150, 46, 0.05) 100%)',
  borderColor: 'rgba(212, 175, 55, 0.1)',
  borderActive: 'rgba(212, 175, 55, 0.2)',
  boxShadow: '0 10px 25px rgba(212, 175, 55, 0.25)',
  glow: '0 0 60px rgba(212, 175, 55, 0.1)'
},
...
{activeTab === 'output' && !loading && (
  <div style={{
    ...
    <CoachOutputDashboard db={db} />
  </div>
)}

{activeTab === 'checkins' && !loading && (
  <div style={{
    background: 'rgba(17, 17, 17, 0.5)',
    backdropFilter: 'blur(10px)',
    borderRadius: '16px',
...
{activeTab === 'funnel' && !loading && (
  <div style={{
    ...
    <FunnelDashboard isMobile={isMobile} />
  </div>
)}
...
{activeTab === 'productivity' && !loading && (
  <div style={{
    background: 'rgba(17, 17, 17, 0.5)',
    backdropFilter: 'blur(10px)',
    borderRadius: '16px',
