// src/sales-call-6week/SixWeekChallengePage.jsx
// Gratis 6 weken 80/20 challenge (/6weekchallenge) — zelfde opbouw en styling
// als de 16-weken pagina: snap scroll, Enter-navigatie, dezelfde drie pijlers.
// Alleen de kop is anders en onderaan staan drie eigen schermen: het systeem,
// de voorwaarden en de garantie. De pijler-sectie wordt uit de 16-weken map
// geïmporteerd, zodat die twee pagina's niet uit elkaar kunnen lopen.
import { useEffect, useRef, useState } from 'react'
import HeroSection from './sections/HeroSection'
import OfferPilarenSection from '../sales-call-16week/sections/OfferPilarenSection'
import ChallengeSection from './sections/ChallengeSection'

const GOLD = '#ffba09'
// Hero + 3 pijler-schermen + systeem, voorwaarden en garantie = 7.
  ...
  return (
    <div ref={pageRef} style={{ background: '#000' }}>
      ...
      >
        ...
        <ChallengeSection isMobile={isMobile} index={0} />
        <ChallengeSection isMobile={isMobile} index={1} />
        <ChallengeSection isMobile={isMobile} index={2} />
      </div>
